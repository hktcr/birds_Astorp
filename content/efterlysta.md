...
/* Active Right Now Effect (Real-time data) */
...
.bounty-card.active-now .bounty-icon {
    filter: drop-shadow(0px 4px 10px rgba(239, 68, 68, 0.7));
    opacity: 0.95;
}
...
@keyframes pulse-red {
    0% { transform: rotate(5deg) scale(1); box-shadow: 0 0 0 0 rgba(239, 68, 68, 0.4); }
    70% { transform: rotate(5deg) scale(1.1); box-shadow: 0 0 0 10px rgba(239, 68, 68, 0); }
    100% { transform: rotate(5deg) scale(1); box-shadow: 0 0 0 0 rgba(239, 68, 68, 0); }
}
...
<div class="bounty-card" data-peak-months="[]" data-active-now="true">
...
<div class="bounty-card" data-peak-months="[]" data-active-now="false">
<div class="bounty-status">Missing</div>
<img class="bounty-icon" src="/images/most-wanted.png" alt="Silhouette of a bird">
