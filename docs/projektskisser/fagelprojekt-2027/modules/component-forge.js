...
(function() {
    ...
    function renderTokenSpinner(s) {
        ...
        // Vocabulary for the LLM to "guess" from
        const decoyWords = ["att", "en", "vi", "robot", "AI", "kan", "skapa", "tänka", "maskin", "framtid", "data", "modell", "tränas", "system", "kod", "förstå", "lära", "skriva", "läsa", "process", "människa", "teknik", "lösning", "problem", "snabbt", "algoritm", "nätverk", "gissa", "kalkylera", "beräkna", "eller", "som", "det", "är", "på", "till", "med", "för", "den", "har", "inte", "av", "om", "så", "bli", "chattbottar", "agenter", "prompt", "token"];
        ...
        setTimeout(() => {
            ...
            async function processNextWord() {
                ...
                if (wordIdx === 0) {
                    ...
                    spinnerWrapper.className = 'ts-spinner-wrapper';
                    ...
                    // The spin duration should be fast but visible (e.g., 0.6s to 0.9s)
                    const duration = 0.6 + Math.random() * 0.3;
                    spinnerTrack.style.transition = `transform ${duration}s cubic-bezier(0.1, 0.8, 0.3, 1)`;
                    ...
                    wordIdx++;
                    // Short pause before starting the next guess
